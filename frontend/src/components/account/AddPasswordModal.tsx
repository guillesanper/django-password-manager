...
import { X, Plus, AlertTriangle, Loader2, Eye, EyeOff, RefreshCw, CheckCircle } from 'lucide-react';
import { useUnifiedTheme } from '../../theme/UnifiedThemeProvider';

interface AddPasswordModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (passwordData: AddPasswordData) => Promise<{ success: boolean; error?: string; message?: string }>;
  loading?: boolean;
