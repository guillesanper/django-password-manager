        ...
        try:
            ...
            try:
                if not minio_service.client.bucket_exists(minio_service.bucket_name):
                    ...
                    self.stdout.write(
                        self.style.WARNING(f'⚠️  Bucket ya existe: {minio_service.bucket_name}')
                    )
                ...
                for test_dir in test_directories:
                    try:
                        ...
                        try:
                            ...
                            self.stdout.write(f'⚠️  Ya existe: {test_dir}')
                        except:
                            # No existe, crearlo
                        ...
                        self.stdout.write(
                            self.style.WARNING(f'⚠️  Error creando {test_dir}: {e}')
                        )
